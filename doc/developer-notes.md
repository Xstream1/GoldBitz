...
GoldKash Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as GoldKash Core, where everyone uses
...
pay attention to for reviewers of GoldKash Core code.

General GoldKash Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: GoldKash Core uses tinyformat, which is type safe. Leave them out to avoid confusion
