...
This mechanism has been integrated into Bitcore-Node-GoldKash which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/goldkashpay/insight-api-goldkash#web-socket-api](https://github.com/goldkashpay/insight-api-goldkash#web-socket-api)
* API: [https://github.com/goldkashpay/insight-api-goldkash#instantsend-transactions](https://github.com/goldkashpay/insight-api-goldkash#instantsend-transactions)
...
By default, the GoldKash Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the GoldKash Core daemon:
