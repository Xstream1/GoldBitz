...
Only requiring some minor changes is goldkash.cpp.
...
Changes to goldkash.cpp
----------------------
goldkash.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
