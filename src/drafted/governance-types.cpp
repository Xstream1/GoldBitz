...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "GoldKashNetwork") type = GoldKashNetwork;
    if(strType == "GoldKashNetworkVariable") type = GoldKashNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == GoldKashNetwork) s = "GoldKashNetwork";
    if(type == GoldKashNetworkVariable) s = "GoldKashNetworkVariable";
