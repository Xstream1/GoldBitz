...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("GoldKash Core goldkash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  goldkash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded goldkash transaction") + "\n" +
              "  goldkash-tx [options] -create [commands]   " + _("Create hex-encoded goldkash transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded goldkash transaction
