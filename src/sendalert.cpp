...
2. run goldkashd with -printalert or -sendalert like this:
   /path/to/goldkashd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.goldkash.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/GoldKash Core:0.12.0.58/"));
