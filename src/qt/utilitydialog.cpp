    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("GoldKash Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About GoldKash Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  goldkash-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the GoldKash in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 XGK, 0.1 XGK, 1 XGK and 10 XGK -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://goldkashpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://goldkashpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("GoldKash Core is shutting down...") + "<br /><br />" +
