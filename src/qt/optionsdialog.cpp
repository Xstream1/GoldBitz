    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("XGK-light"), QVariant("light"));
    ui->theme->addItem(QString("XGK-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("XGK-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("XGK-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("XGK-traditional"), QVariant("trad"));
