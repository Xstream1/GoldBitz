    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("GoldKash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GoldKash address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and goldkash: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About GoldKash Core"), this);
    aboutAction->setStatusTip(tr("Show information about GoldKash Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GoldKash Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GoldKash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GoldKash addresses"));
    ...
    openAction->setStatusTip(tr("Open a goldkash: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the GoldKash Core help message to get a list with possible GoldKash Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("GoldKash Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GoldKash network", "", count));
    } else {
...
{
    QString strTitle = tr("GoldKash Core"); // default title
