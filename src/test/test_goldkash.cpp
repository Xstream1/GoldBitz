...
#define BOOST_TEST_MODULE GoldKash Test Suite

#include "test_goldkash.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_goldkash_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
