...
public:
    CMainParams() {
        ...
        consensus.nPowTargetSpacing = 2.5 * 60; // GoldKash: 2.5 minutes
        ...
        vSeeds.push_back(CDNSSeedData("goldkash.org", "dnsseed.goldkash.org"));
        vSeeds.push_back(CDNSSeedData("goldkashdot.io", "dnsseed.goldkashdot.io"));
        vSeeds.push_back(CDNSSeedData("masternode.io", "dnsseed.masternode.io"));
        vSeeds.push_back(CDNSSeedData("goldkashpay.io", "dnsseed.goldkashpay.io"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("goldkashdot.io",  "testnet-seed.goldkashdot.io"));
